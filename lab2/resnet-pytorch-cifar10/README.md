本代码来源于：https://github.com/akamaster/pytorch_resnet_cifar10

我在其中添加了一些注释便于理解，并根据实验要求增加了一些模块，并在代码结尾对gpu的显存进行了释放

运行方法为：

1、默认模型我已经更改为resnet20，如果想尝试其他模型需要手动调节参数

```
python trainer.py
```

2、运行所有resnet网络，使用默认参数
